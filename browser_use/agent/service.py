...
class Agent(Generic[Context]):
    ...
    def _set_message_context(self) -> str | None:
        """Set the message context based on tool calling method"""
        if self.tool_calling_method == 'raw':
            if self.settings.message_context:
                return f'{self.settings.message_context}\n\nAvailable actions: {self.available_actions}'
            else:
                return f'Available actions: {self.available_actions}'
    ...
    def _set_model_names(self) -> None:
        """Set model names for logging and telemetry"""
    ...
    def _set_tool_calling_method(self) -> Optional[ToolCallingMethod]:
        """Set the appropriate tool calling method based on the model"""
    ...
    async def get_next_action(self, input_messages: list[BaseMessage]) -> AgentOutput:
        ...
        if self.tool_calling_method == 'raw':
            ...
            # Remove think tags from output content
